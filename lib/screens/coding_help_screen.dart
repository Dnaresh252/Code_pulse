...
""";
  ...
  void _saveNote() {
    if (_response.isNotEmpty) {
      ...
      setState(() {
        _savedNotes.add(_questionController.text);
      });
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.language, color: Color(0xFF3B82F6), size: 20),
                        SizedBox(width: 8),
                        Text(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(color: Color(0xFF3B82F6).withOpacity(0.5)),
                      ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.help_outline, color: Color(0xFF3B82F6), size: 20),
                        SizedBox(width: 8),
                        Text(
              ...
              if (_hasResponse || _isLoading)
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    Expanded(
                    child: Text(
                    _isLoading ? 'AI is thinking...' : 'Your Answer',
                    style: TextStyle(
                    color: Colors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    ...
                    if (_response.isNotEmpty) ...[
                    IconButton(
                    icon: Icon(Icons.copy, color: Color(0xFF3B82F6)),
                    onPressed: _copyToClipboard,
                    tooltip: 'Copy answer',
                    ),
                    IconButton(
                    icon: Icon(Icons.bookmark_add, color: Color(0xFF3B82F6)),
                    onPressed: _saveNote,
                    tooltip: 'Save note',
                    ),
                    ],
          ...
          child: Column(
            ...
            children: [
              ...
              if (_savedNotes.isEmpty)
                ...
                ...(_savedNotes.map((note) => ListTile(
                  leading: Icon(Icons.note, color: Color(0xFF3B82F6)),
                  title: Text(
                    note,
                    style: TextStyle(color: Colors.white),
                  ),
